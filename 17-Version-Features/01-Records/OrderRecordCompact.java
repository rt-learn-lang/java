/**
 * Demo of using a compact constructor to prevent a mutable list from being modified.
 */
...
public record OrderRecordCompact(long id, CustomerRecord customer, LocalDateTime dateTime,
	...
	public OrderRecordCompact {
		...
		lines = List.copyOf(lines); // Making an unmodifiable defensive copy of the argument
